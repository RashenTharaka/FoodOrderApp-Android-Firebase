...
public class CartAdapter extends RecyclerView.Adapter<CartAdapter.viewholder> {
    ...
    public void onBindViewHolder(@NonNull CartAdapter.viewholder holder, int position) {
        ...
        holder.plusItem.setOnClickListener(v -> {
            ...
            managmentCart.plusNumberItem(list, adapterPosition, () -> {
        ...
        holder.minusItem.setOnClickListener(v -> {
            ...
            int oldQuantity = list.get(adapterPosition).getNumberInCart();
            managmentCart.minusNumberItem(list, adapterPosition, () -> {
                if (oldQuantity <= 1) {
        ...
        holder.trashBtn.setOnClickListener(v -> {
            ...
            managmentCart.removeItem(list, adapterPosition, () -> {
                notifyItemRemoved(adapterPosition);
                changeNumberItemsListener.change();
            });
        });
